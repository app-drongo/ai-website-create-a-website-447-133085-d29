  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Tech Careers', href: '/careers' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Tech Webinars', href: '/webinars' },
        { name: 'Implementation Cases', href: '/case-studies' },
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Powering the next generation of technology solutions with cutting-edge cloud
                infrastructure and developer tools. Trusted by enterprise teams worldwide for
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">engineering@acmetech.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <Phone className="size-4 text-primary flex-shrink-0" />
                <span className="text-muted-foreground">+1 (555) ACME-TECH</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Get technical updates, API changes, and platform news. Unsubscribe anytime.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span className="hidden sm:inline flex items-center gap-1">
                Built with <Heart className="size-3 text-red-500 fill-current" /> by engineers
              </span>
            </div>
