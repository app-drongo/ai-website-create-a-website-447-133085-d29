...
export default function Hero({
  ...
  title = 'Build scalable applications with',
  titleHighlight = 'Acme Tech Solutions',
  description = 'Enterprise-grade development platform that accelerates your software delivery with cutting-edge automation, seamless integrations, and intelligent monitoring.',
  features = [
  ...
  imageUrl = 'https://images.unsplash.com/photo-1551434678-e076c223a692?q=80&w=1920&auto=format&fit=crop',
  imageAlt = 'Acme Tech Dashboard Interface',
  statsLabel1 = 'Performance',
  statsValue1 = '10x Faster',
  statsLabel2 = 'Reliability',
  statsValue2 = '99.99% SLA',
}: HeroProps) {
